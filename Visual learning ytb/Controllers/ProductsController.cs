...
namespace Visual_learning_ytb.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(Visual_learning_ytbContext context)
        {
            _context = context;
        }
        ...
        {
            var visual_learning_ytbContext = _context.Product.Include(p => p.Category);
            return View(await visual_learning_ytbContext.ToListAsync());
        }
        [HttpPost]
		public async Task<IActionResult> Index(int catid, string keywords)
		{
			var visual_learning_ytbContext = _context.Product.Include(p => p.Category).Where(p=>p.Name.Contains(keywords) && p.CategoryId==catid);
			return View(await visual_learning_ytbContext.ToListAsync());
		}
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Visual_learning_ytbContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
